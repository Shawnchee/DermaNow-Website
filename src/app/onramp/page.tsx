...
export default function OnrampPage() {
  ...
  return (
    <div
      className="min-h-screen overflow-hidden relative bg-zinc-50 dark:bg-zinc-950"
      ref={containerRef}
    >
      ...
      />
      <motion.div
        className="absolute top-40 right-[15%] w-96 h-96 bg-green-300/10 rounded-full blur-3xl"
        style={{ y: y2 }}
      />
      <motion.div
        className="absolute bottom-20 left-[25%] w-80 h-80 bg-purple-300/10 rounded-full blur-3xl"
        style={{ y: y3 }}
      />
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        >
          ...
          >
            <motion.img
              ...
              alt="DeFi Icon"
              className="h-48 w-h-48 relative z-10"
              whileHover={{
                y: -5,
          ...
          >
            Easily purchase ETH with your local currency and e-wallet. Funds
            will be sent directly to your Sepolia testnet wallet.
          </motion.p>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-800 font-medium">
                  Destination: {walletAddress.slice(0, 6)}...
        ...
        <motion.div
          ...
          style={{
            y: useTransform(smoothScrollY, [0, 1], [0, 40]),
            scale: useTransform(smoothScrollY, [0, 1], [1, 1.05]),
          }}
        >
          {transactionStatus ? (
            <Card className="border-blue-200 shadow-md backdrop-blur-sm bg-white/90">
              <CardHeader>
                    ...
                    <div className="flex flex-col items-center">
                      <div className="relative">
                        {qrRefreshing ? (
                          ...
                          <>
                            <QRCode
                              value={`ethereum:${paymentAddress}?amount=${calculateEthAmount(
                                amount
                              )}&ref=${transactionRef}`}
                              size={256}
                              quietZone={10}
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-amber-800">
                            This is a demo for presentation purposes
                          </p>
                          <p className="text-xs text-amber-700 mt-1">
                            In a real implementation, this would connect to
                            MoonPay's API for actual purchases. For this demo,
                            we're simulating the purchase flow.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex flex-col items-center justify-center py-6">
                      ...
                      <p className="text-gray-600 text-center max-w-md mb-2">
                        {calculateEthAmount(amount)} ETH has been sent to your
                ...
                {transactionStatus === "failed" && (
                  <div className="flex flex-col items-center justify-center py-12">
                    ...
                    <p className="text-gray-600 text-center max-w-md mb-6">
                      There was an issue processing your transaction. Please try
                      again.
                    </p>
            ...
            <Card className="border-blue-200 py-8 shadow-lg hover:shadow-xl transition-all duration-500 backdrop-blur-sm bg-white/90">
              <CardHeader>
                <CardTitle className="flex items-center">
                  <DollarSign className="h-6 w-6 text-green-600 mr-2" />
                  Buy ETH with Local Currency
                  ...
                  <Tabs defaultValue="ewallet" className="w-full mb-6">
                        ...
                        <div className="bg-amber-50 border border-amber-200 p-4 rounded-lg">
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-amber-700 mt-1">
                                Bank transfer functionality is simulated for
                                this demo. In a real implementation, this would
                                connect to MoonPay's API.
                              </p>
                            </div>
                          </div>
                        </div>
                        <p className="text-sm text-gray-600">
                          Bank transfer is available but all options will use
                          the QR code flow for this demo.
                        </p>
                      </div>
                    </TabsContent>
                    ...
                    <TabsContent value="card">
                      <div className="space-y-4">
                        <div className="bg-amber-50 border border-amber-200 p-4 rounded-lg">
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-amber-700 mt-1">
                                Credit card functionality is simulated for this
                                demo. In a real implementation, this would
                                connect to MoonPay's API.
                              </p>
                            </div>
                          </div>
                        ...
                        <p className="text-sm text-gray-600">
                          Credit card payment is available but all options will
                          use the QR code flow for this demo.
                        </p>
                      </div>
                    </TabsContent>
                  </Tabs>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-blue-700 mt-1">
                            This is a simulated onramp service for demonstration
                            purposes. No actual transactions will be processed.
                            In a real implementation, this would integrate with
                            MoonPay's API to process real transactions.
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <CardFooter className="flex flex-col items-start">
                ...
                <div className="text-xs text-gray-400">
                  ETH will be sent to your connected wallet on the Sepolia
                  testnet
                </div>
              </CardFooter>
            </Card>
      ...
      {/* Parallax footer decoration */}
      <motion.div
        className="absolute bottom-0 w-full h-20 bg-gradient-to-t from-blue-100/30 to-transparent"
        style={{ y: useTransform(smoothScrollY, [0, 1], [0, -10]) }}
      />
    </div>
  );
