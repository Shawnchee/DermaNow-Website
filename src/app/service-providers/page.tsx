    ...
    const fetchServiceProviders = async () => {
      ...
      try {
        ...
        const mockProviders: ServiceProvider[] = [
          {
            ...
            social_media: {
              ...
              instagram: "buildright_construction",
            },
            contact_email: "info@buildright.org",
            website: "https://buildright.org",
            ...
            portfolio: [
              {
                ...
                image:
                  "/placeholder.svg?height=300&width=400&text=Digital+Classroom",
              },
              {
                id: "p5",
                ...
                image:
                  "/placeholder.svg?height=300&width=400&text=Teacher+Training",
              },
            ],
            social_media: {
              twitter: "edutech_solutions",
              facebook: "edutechsolutions",
              linkedin: "edutech-solutions",
            },
            contact_email: "contact@edutech.org",
          ...
          },
          {
            ...
            portfolio: [
              {
                ...
                image:
                  "/placeholder.svg?height=300&width=400&text=Mobile+Clinics",
              },
              {
                id: "p7",
                ...
                image:
                  "/placeholder.svg?height=300&width=400&text=Maternal+Care",
              },
              {
                id: "p8",
            ...
            social_media: {
              twitter: "medicare_services",
              instagram: "medicare_services",
              linkedin: "medicare-services",
            },
            contact_email: "info@medicare-services.org",
            website: "https://medicare-services.org",
          ...
          },
          {
            ...
            portfolio: [
              {
                ...
                image:
                  "/placeholder.svg?height=300&width=400&text=Reforestation",
              },
              {
                id: "p10",
            ...
            social_media: {
              twitter: "greenearth",
              instagram: "greenearth_initiative",
              facebook: "greenearthinitiative",
            },
          ...
          },
          {
            ...
            portfolio: [
              ...
              },
              {
                ...
                image:
                  "/placeholder.svg?height=300&width=400&text=Coding+Bootcamps",
              },
            ],
            social_media: {
              twitter: "techforall",
              linkedin: "tech-for-all",
              instagram: "techforall_org",
            },
            contact_email: "hello@techforall.org",
          ...
          },
          {
            ...
            portfolio: [
              ...
              },
              {
                ...
                image:
                  "/placeholder.svg?height=300&width=400&text=School+Meals",
              },
              {
                id: "p15",
                ...
                image:
                  "/placeholder.svg?height=300&width=400&text=Distribution+Centers",
              },
            ],
            social_media: {
              twitter: "foodbank_network",
              facebook: "foodbanknetwork",
              instagram: "foodbank_network",
            },
            contact_email: "info@foodbanknetwork.org",
            website: "https://foodbanknetwork.org",
          ...
          },
          {
            ...
            social_media: {
              twitter: "shelterplus",
              facebook: "shelterplusorg",
              instagram: "shelter_plus",
            },
            contact_email: "contact@shelterplus.org",
            website: "https://shelterplus.org",
          ...
          },
          {
            ...
            portfolio: [
              {
                ...
                image:
                  "/placeholder.svg?height=300&width=400&text=Well+Drilling",
              },
              {
                id: "p19",
            ...
            social_media: {
              twitter: "cleanwater_projects",
              linkedin: "cleanwater-projects",
              facebook: "cleanwaterprojects",
            },
            contact_email: "info@cleanwaterprojects.org",
            website: "https://cleanwaterprojects.org",
        ...
        const types = Array.from(
          new Set(mockProviders.map((provider) => provider.service_type))
        );
        setServiceTypes(types);

        // Apply initial filter if type is specified
        if (initialType !== "all") {
          setFilteredProviders(
            mockProviders.filter(
              (provider) => provider.service_type === initialType
            )
          );
        } else {
                          ...
                          <DialogHeader>
                            <div className="flex items-center gap-4">
                              <div className="h-16 w-16 rounded-md overflow-hidden bg-blue-100">
                                <img
                                  src={
                                    selectedProvider.logo || "/placeholder.svg"
                                  }
                                  ...
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                      ...
                                      <div className="flex gap-3 mt-2">
                                        {selectedProvider.social_media
                                          .twitter && (
                                          <a
                                            href={`https://twitter.com/${selectedProvider.social_media.twitter}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                        ...
                                        {selectedProvider.social_media
                                          .instagram && (
                                          <a
                                            href={`https://instagram.com/${selectedProvider.social_media.instagram}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                        ...
                                        {selectedProvider.social_media
                                          .linkedin && (
                                          <a
                                            href={`https://linkedin.com/company/${selectedProvider.social_media.linkedin}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                        ...
                                        {selectedProvider.social_media
                                          .facebook && (
                                          <a
                                            href={`https://facebook.com/${selectedProvider.social_media.facebook}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
