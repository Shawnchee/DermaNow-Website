    ...
    <ParallaxProvider>
      <div className="min-h-screen pt-8 pb-8 px-6 bg-zinc-50 dark:bg-zinc-950">
        <div className="container mx-auto px-4 py-12">
          <Parallax speed={-20} className="overflow-hidden rounded-xl mb-12">
            <motion.div
          ...
          <Parallax speed={5} className="my-8">
            <Alert className="bg-blue-50 border-blue-200">
              <AlertTriangle className="h-5 w-5 text-blue-600" />
              <AlertTitle>Sequential Milestone Funding</AlertTitle>
              <AlertDescription>
                Milestones are funded sequentially. Only the active milestone
                can receive donations. Each milestone requires {votingThreshold}{" "}
                ...
                <CardContent className="pt-6 pb-6">
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        (window.location.href = "/committee-voting")
                      }
                    >
                      Go to Voting Panel
                    </Button>
          ...
          <Parallax speed={3} className="mb-16">
            <div ref={milestonesRef}>
              ...
              {loading ? (
                ...
                <Card className="bg-white/80 backdrop-blur-sm border border-blue-100">
                  <CardContent className="flex flex-col items-center justify-center py-12">
                    ...
                    <p className="text-gray-600 text-center max-w-md">
                      There are currently no active charity milestones. Check
                ...
                Object.entries(
                  milestonesByProject as Record<string, any[]>
                ).map(([projectTitle, projectMilestones], groupIndex) => (
                            ...
                            <Card
                              className={`bg-white/90 backdrop-blur-sm border ${
                                activeMilestoneId === milestone.id
                                  ...
                                  ? "border-gray-200"
                                  : "border-blue-100"
                              } overflow-hidden h-full flex flex-col relative p-2 transition-all duration-300`}
                            >
                              {activeMilestoneId === milestone.id && (
              ...
              <div className="mb-12">
                <Card className="bg-white/80 backdrop-blur-sm border border-blue-100">
                  <CardContent className="flex flex-col items-center justify-center py-12">
                    ...
                    <p className="text-gray-600 text-center max-w-md">
                      There are currently no transaction history available.
          ...
          <Parallax speed={3} className="mb-12">
          ...
          <Parallax speed={5} className="mb-6 mt-12">
          ...
          <Parallax speed={10} className="mb-8">
            <div className="bg-white rounded-lg shadow-md p-6 border border-blue-100">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-4">
                    Help ensure transparency and accountability by joining our
                    DAO committee. As a committee member, you'll vote on
                    milestone completions and fund releases.
                  </p>
                  <div className="space-y-4">
                    <p className="text-sm text-gray-700">
                      <span className="font-medium">Requirements:</span> Active
                      wallet with at least 0.1 ETH in transactions, commitment
                      to review project milestones, and adherence to our ethical
                      guidelines.
                    </p>
                    <Alert className="bg-blue-50 border-blue-200">
                      ...
                      <AlertDescription>
                        Committee members participate in decentralized
                        governance through transparent voting on the blockchain.
                      </AlertDescription>
                    </Alert>
